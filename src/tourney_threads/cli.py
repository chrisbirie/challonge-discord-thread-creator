...
from .discord_client import DiscordThreadManager, print_debug_summary, print_dry_run
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--tournament", help="Override tournament slug/id from config (e.g., EBSSTEST)"
    )
    parser.add_argument("--debug", action="store_true", help="Print raw JSON and match summary")
    parser.add_argument(
        "--dry-run", action="store_true", help="Print thread previews instead of creating them"
    )
